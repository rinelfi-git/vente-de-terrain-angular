export class Urls {
  ...
  private BACK_END_NAMESPACE = '/';

  private IMAGE_SERVER_PROTOCOL = 'http://';
  private IMAGE_SERVER_HOST = 'localhost';
  private IMAGE_SERVER_PORT = 80;
  private PROFILE_SERVER_NAMESPACE = '/localstorage/vente-de-terrain/images/clients/';
  private FIELD_SERVER_NAMESPACE = '/localstorage/vente-de-terrain/images/terrains/';
